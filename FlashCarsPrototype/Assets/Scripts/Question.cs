...
public class Question : MonoBehaviour
{
    ...
    public static Dictionary<string, string[]> GetQuestionCatagory(string sub, string diff)
    {
        if (sub == "Math")
        {
            if (diff == "Easy")
    ...
    private void GenerateQuestions()
    {
        ...
        questionSet["HistoryE"] = new Dictionary<string, string[]>
        {
            ...
            {"Name one reason European settlers came to North America in the 1600s.", new[] {"Religious freedom", "Trade"} },
            {"Which direction is opposite North on a compass?", new[] {"South", "East"} },
            {"Name one artifact archaeologists study to learn about early Native Peoples.", new[] {"Stone tools", "Clothes"} },
        ...
        questionSet["HistoryH"] = new Dictionary<string, string[]>
        {
            ...
            {"What is the purpose of checks and balances in the U.S. government?", new[] {"Prevent too much power", "Make laws faster"} },
        ...
        questionSet["ScienceH"] = new Dictionary<string, string[]>
        {
            ...
            {"What is the layer of gases around Earth called?", new[] {"Atmosphere", "Stratosphere"} },
        ...
        questionSet["ScienceH"] = new Dictionary<string, string[]>
        {
            ...
            {"What is the process by which water changes from gas to liquid?", new[] {"Condensation", "Evaporation"} },
            {"What is the term for animals eating both plants and animals?", new[] {"Omnivore", "Carnivore"} },
            {"What is the hottest layer of the Earth?", new[] {"Inner core", "Mantle"} },
